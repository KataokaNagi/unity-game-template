...
/// @brief    Buttons can easily make various AddListeners.
/// @use      
/// @use      buttonTrigger.AddPointerClickListener(_ => Debug.Log("Clicked!"));
/// @auther   Kataoka, takuyayamada
/// @date     2022-05-07 17:11:09
/// @version  1.0
/// @history  add
/// @see      [【Unity】EventTrigger のイベント登録を簡潔に書ける拡張メソッド](https://qiita.com/Yamara/items/42b18a402c5bda132f37)
/// /// </summary>
